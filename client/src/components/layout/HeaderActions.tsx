...
export const HeaderActions: React.FC<HeaderActionsProps> = ({
  ...
  return (
    <div className="absolute top-4 right-4 z-20 flex items-center gap-4 bg-transparent">
      <Button onClick={onExportPNG} variant="outline" disabled={!onExportPNG} className="text-black dark:text-white border-black dark:border-white">
        <Download className="mr-2 h-4 w-4" />
        Export PNG
      </Button>
      <Button onClick={onExportPDF} variant="outline" disabled={!onExportPDF} className="text-black dark:text-white border-black dark:border-white">
        <Download className="mr-2 h-4 w-4" />
        Export PDF
      </Button>
      <Button onClick={onCopyRoomId} variant="outline" disabled={!onCopyRoomId} className="text-black dark:text-white border-black dark:border-white">
